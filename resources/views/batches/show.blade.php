...
@section('show')
    <div class="col-12">
        <h2 class="h3 mb-4 page-title">View Batch</h2>
        <div class="row mt-5 align-items-center">
            ...
            <div class="col">
                <div class="row align-items-center">
                    <div class="col-md-7">
                        <h4 class="mb-1">{{ $batches->name }}</h4>
                        <div class="row ml-1">
                            <p class="small"><span class="badge badge-dark">{{ $batches->course_id }},</span></p>
                            <p class="small"><span class="badge badge-dark">{{ $batches->start_date }}</span></p>
                        </div>
                    </div>
                </div>
                <div class="row mb-4">
