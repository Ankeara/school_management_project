                    ...
                    <form action="{{ url('courses/' . $courses->id) }}" method="POST">
                        <div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" value="{{ $courses->name }}" id="name" name="name"
                                    class="form-control" placeholder="name">
                            </div>
                            <div class="form-group mb-3">
                                <label for="syllabus">Syllabus</label>
                                <input type="text" value="{{ $courses->syllabus }}" id="syllabus" name="syllabus"
                                    class="form-control col-12" placeholder="Asddress">
                            </div>
                            <div class="form-group mb-3">
                                <label for="duration">Duration</label>
                                <input type="text" value="{{ $courses->duration }}" id="duration" name="duration"
