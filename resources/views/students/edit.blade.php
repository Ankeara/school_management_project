                    ...
                    <form action="{{ url('students/' . $students->id) }}" method="POST">
                        <div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" value="{{ $students->name }}" id="name" name="name"
                                    class="form-control" placeholder="name">
                            </div>
                            <div class="form-group mb-3">
                                <label for="address">Address</label>
                                <input type="text" value="{{ $students->address }}" id="address" name="address"
                                    class="form-control col-12" placeholder="Asddress">
                            </div>
                            <div class="form-group mb-3">
                                <label for="mobile">Mobile</label>
                                <input type="text" value="{{ $students->mobile }}" id="mobile" name="mobile"
