...
@section('show')
    <div class="col-12">
        <h2 class="h3 mb-4 page-title">View Teacher</h2>
        <div class="row mt-5 align-items-center">
            ...
            <div class="col">
                <div class="row align-items-center">
                    <div class="col-md-7">
                        <h4 class="mb-1">{{ $teachers->name }}</h4>
                        <div class="row ml-1">
                            <p class="small"><span class="badge badge-dark">{{ $teachers->address }},</span></p>
                            <p class="small"><span class="badge badge-dark">{{ $teachers->mobile }}</span></p>
                        </div>
                    </div>
                </div>
                <div class="row mb-4">
        ...
        <div class="row ml-1"><a href="{{ url('/teachers') }}"
