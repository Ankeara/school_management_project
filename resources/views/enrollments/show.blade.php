...
@section('show')
    <div class="col-12">
        <h2 class="h3 mb-4 page-title">View Enrollments</h2>
        <div class="row mt-5 align-items-center">
            <div class="col-md-3 text-center mb-5">
                <div class="avatar avatar-xl">
                    <img src="{{ url('assets/images/online-education.png') }}" alt="..."
            ...
            <div class="col">
                <div class="row align-items-center">
                    <div class="col-md-7">
                        <h4 class="mb-1">{{ $enrollments->enroll_no }}</h4>
                        <div class="row ml-1">
                            <p class="small"><span class="badge badge-dark">{{ $enrollments->batches_name }},</span></p>
                            <p class="small"><span class="badge badge-dark">{{ $enrollments->student_name }}</span></p>
                        </div>
                    </div>
                </div>
                <div class="row mb-4">
        ...
        <div class="row ml-1"><a href="{{ url('/batches') }}"
